...
from langraph_pipeline.nodes import code_testing_node
from langraph_pipeline.state import AutoGITState
...
"""
    ...
    assert result.get('tests_passed'), "Good code should pass"
...
"""
    ...
    # This code has security issues, so it should have lower quality
    quality2 = result2.get('code_quality', 0)
    assert quality2 < 90, "Code with security issues should have lower quality"
